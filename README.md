...
This site showcases my background, experience, and AI product demos. Built as a single-page scrollable portfolio with sections for:
...
|------|-------------|-----------|
| AI Paper Trading Bot | A dual-strategy autonomous trading system powered by Claude AI. | [Visit](https://alpaca-trading-dashboard-aanl.onrender.com/) |
| Babu Learns Gujarati V2.1 | A flashcard app for kids to learn Gujarati. | [Visit](https://rujutagandhi.github.io/babu_learns_gujarati) |
...
- [LinkedIn](https://linkedin.com/in/gandhirujuta)
- [GitHub](https://github.com/RujutaGandhi)
